const projects = [
  {
    ...
    title: "CodeAgent",
    description:
      "An autonomous coding agent that plans and executes multi-step tasks through the Anthropic API. Runs an iterative plan-act loop, reading and editing files, running code, and self-correcting from execution results, with runs isolated in Docker sandboxes.",
    tags: ["Python", "Anthropic API", "Docker"],
    link: "https://github.com/lukee-d/codeagent",
