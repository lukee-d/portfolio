...
const COMMANDS: Record<string, string[]> = {
  ...
  experience: [
    "Where I've worked:",
    "",
    "  Hynes & Khater            SWE Intern (2026 – present)",
    "    Full-stack PASS Travel app + AI QA pipeline",
    "",
    "  Geophysical Technology    SWE Intern (2023 & 2025)",
    "    RFID integration in C++/C#, Python automation",
  ],
  projects: [
    "Featured projects:",
    "",
    "  01  CodeAgent             — Autonomous coding agent",
    "      github.com/lukee-d/codeagent",
    "",
    "  02  Sift                  — Client-side search engine",
    "      sift-khaki.vercel.app",
    "",
    "  03  Chess Dashboard       — Chess.com analytics",
    "      chess-dashboard-two.vercel.app",
    "",
    "  04  Song Wars             — Multiplayer music game",
    "      song-wars.netlify.app",
    "",
    "  05  MCSR Stats            — Speedrun analytics",
  ...
  currently: [
    "📚 Learning     LLM agents & full-stack",
    "🔨 Building     CodeAgent & side projects",
    "💼 Interning    SWE @ Hynes & Khater",
  ],
  sudo: [
